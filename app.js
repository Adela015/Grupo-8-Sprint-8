...
const userRutasAPI = require('./src/routers/api/userRouterApi')
const productRutasAPI = require('./src/routers/api/productRouterApi')
...
app.use('/api/users', userRutasAPI)
app.use('/api/products', productRutasAPI)
